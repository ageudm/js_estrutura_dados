...
form.addEventListener('submit', (e) => {
  e.preventDefault(); //remove o evento nativo do botão submit
  const value = parseInt(amountInput.value)
  const random = Math.floor(Math.random() * text.length) //criar ummetodo alertorio
